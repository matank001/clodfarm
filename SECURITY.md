...
In scope: the claude-farm code, the Docker image and the AWS template. Out of scope: Claude Code itself (report those
to Anthropic) and prompt-injection behaviour of the model, unless claude-farm makes it worse than plain Claude Code.
